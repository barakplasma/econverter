...
class TabletOutput(iPadOutput):
    name = "Tablet"
    short_name = "tablet"
    description = "Intended for generic tablet devices, does no resizing of images"
...
class SamsungGalaxy(TabletOutput):
    ...
    short_name = "galaxy"
    description = (
        "Intended for the Samsung Galaxy and similar tablet "
...
class NookHD(TabletOutput):
    ...
    description = (
        "Intended for the Nook HD+ and similar tablet devices with "
...
class GenericEinkHD(GenericEink):
    ...
    description = "Suitable for use with any modern high resolution e-ink device"
...
class SonyReaderLandscapeOutput(SonyReaderOutput):
    ...
    description = (
        "This profile is intended for the SONY PRS line. "
...
class KindlePaperWhiteOutput(KindleOutput):
    ...
    description = "This profile is intended for the Amazon Kindle PaperWhite 1 and 2"
...
class KindleOasisOutput(KindlePaperWhite3Output):
    ...
    description = "This profile is intended for the Amazon Kindle Oasis 2017 and above"
    # Screen size is currently just the spec size, actual renderable area will
    # depend on someone with the device doing tests.
