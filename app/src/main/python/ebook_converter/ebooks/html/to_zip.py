...
class HTML2ZIP(FileTypePlugin):
            ...
            if self.site_customization and self.site_customization.strip():
                ...
                if enc:
                    try:
                        ...
                        print("Ignoring invalid input encoding for HTML: %s", enc)
                    else:
    ...
    def do_user_config(self, parent=None):
        ...
        from ebook_converter.customize.ui import plugin_customization, customize_plugin
        ...
        bf.setToolTip(
            "Normally, when following links in HTML files calibre "
