...
ALL_METADATA_FIELDS = (
    SOCIAL_METADATA_FIELDS.union(PUBLICATION_METADATA_FIELDS)
...
SC_FIELDS_COPY_NOT_NULL = frozenset(
    ("device_collections", "lpath", "size", "comments", "thumbnail")
)

# Metadata fields that smart update should copy without special handling
SC_COPYABLE_FIELDS = SOCIAL_METADATA_FIELDS.union(PUBLICATION_METADATA_FIELDS).union(
    BOOK_STRUCTURE_FIELDS
).union(DEVICE_METADATA_FIELDS).union(
    CALIBRE_METADATA_FIELDS
) - SC_FIELDS_NOT_COPIED.union(SC_FIELDS_COPY_NOT_NULL)

SERIALIZABLE_FIELDS = SOCIAL_METADATA_FIELDS.union(USER_METADATA_FIELDS).union(
    PUBLICATION_METADATA_FIELDS
).union(CALIBRE_METADATA_FIELDS).union(DEVICE_METADATA_FIELDS) - frozenset(
    ("device_collections", "formats", "cover_data")
)
