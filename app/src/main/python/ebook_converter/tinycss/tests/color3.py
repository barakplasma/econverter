...
class TestColor3(BaseTest):
    def test_color_parsing(self):
        for css_source, expected_result in [
            ...
            ("cyan", (0, 1, 1, 1)),
            ("CyAn", (0, 1, 1, 1)),
            ("darkkhaki", (189 / 255.0, 183 / 255.0, 107 / 255.0, 1)),
            ("#", None),
            ("#f", None),
            ("#ff", None),
            ("#fff", (1, 1, 1, 1)),
            ...
            ("#ffffffff", None),
            ("#fffffffff", None),
            ("#cba987", (203 / 255.0, 169 / 255.0, 135 / 255.0, 1)),
            ("#CbA987", (203 / 255.0, 169 / 255.0, 135 / 255.0, 1)),
            ("#1122aA", (17 / 255.0, 34 / 255.0, 170 / 255.0, 1)),
            ("#12a", (17 / 255.0, 34 / 255.0, 170 / 255.0, 1)),
            ("rgb(203, 169, 135)", (203 / 255.0, 169 / 255.0, 135 / 255.0, 1)),
            ...
            ("rgb(-51, 306, 0)", (-0.2, 1.2, 0, 1)),  # out of 0..1 is allowed
            ...
            ("rgb(-12%, 110%, 1400%)", (-0.12, 1.1, 14, 1)),  # out of 0..1 is allowed
            ("rgb(10%, 50%, 0)", None),
            ("rgb(255, 50%, 0%)", None),
            ("rgb(0, 0 0)", None),
            ("rgb(0, 0, 0deg)", None),
            ...
            ("rgba(203, 169, 135, 0.3)", (203 / 255.0, 169 / 255.0, 135 / 255.0, 0.3)),
