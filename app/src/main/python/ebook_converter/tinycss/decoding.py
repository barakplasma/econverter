...
def decode(
    css_bytes, protocol_encoding=None, linking_encoding=None, document_encoding=None
):
    """
    ...
    for encoding, pattern in ENCODING_MAGIC_NUMBERS:
        ...
        if match:
            ...
            if css_unicode and not (
                has_at_charset and not css_unicode.startswith('@charset "')
            ):
...
def hex2re(hex_data):
    return re.escape(polyglot.from_hex_bytes(hex_data.replace(" ", "").encode("ascii")))
...
ENCODING_MAGIC_NUMBERS = [
    ...
    ("UTF-8", re.compile(hex2re("EF BB BF")).match),
    (
        (Slice[:], ""),
        re.compile(
            hex2re("40 63 68 61 72 73 65 74 20 22") + b"([^\x22]*?)" + hex2re("22 3B")
        ).match,
    ),
    (
        (Slice[1::2], "-BE"),
        re.compile(
            hex2re("FE FF 00 40 00 63 00 68 00 61 00 72 00 73 00 65 0074 00 20 00 22")
            + b"((\x00[^\x22])*?)"
            + hex2re("00 22 00 3B")
        ).match,
    ),
    (
        (Slice[1::2], "-BE"),
        re.compile(
            hex2re("00 40 00 63 00 68 00 61 00 72 00 73 00 65 00 74 0020 00 22")
            + b"((\x00[^\x22])*?)"
            + hex2re("00 22 00 3B")
        ).match,
    ),
    (
        (Slice[::2], "-LE"),
        re.compile(
            hex2re("FF FE 40 00 63 00 68 00 61 00 72 00 73 00 65 00 7400 20 00 22 00")
            + b"(([^\x22]\x00)*?)"
            + hex2re("22 00 3B 00")
        ).match,
    ),
    (
        (Slice[::2], "-LE"),
        re.compile(
            hex2re("40 00 63 00 68 00 61 00 72 00 73 00 65 00 74 00 2000 22 00")
            + b"(([^\x22]\x00)*?)"
            + hex2re("22 00 3B 00")
        ).match,
    ),
    (
        ...
        re.compile(
            hex2re(
                "00 00 FE FF 00 00 00 40 00 00 00 63 00 00 00 68 00"
                "00 00 61 00 00 00 72 00 00 00 73 00 00 00 65 00 00"
                "00 74 00 00 00 20 00 00 00 22"
            )
            + b"((\x00\x00\x00[^\x22])*?)"
            + hex2re("00 00 00 22 00 00 00 3B")
        ).match,
    ),
    (
        (Slice[3::4], "-BE"),
        re.compile(
            hex2re(
                "00 00 00 40 00 00 00 63 00 00 00 68 00 00 00 61 00"
    ...
    (
        ...
        re.compile(
            hex2re(
                "FF FE 00 00 40 00 00 00 63 00 00 00 68 00 00 00 61"
                "00 00 00 72 00 00 00 73 00 00 00 65 00 00 00 74 00"
                "00 00 20 00 00 00 22 00 00 00"
            )
            + b"(([^\x22]\x00\x00\x00)*?)"
            + hex2re("22 00 00 00 3B 00 00 00")
        ).match,
    ),
    (
        (Slice[::4], "-LE"),
        re.compile(
            hex2re(
                "40 00 00 00 63 00 00 00 68 00 00 00 61 00 00 00 72"
    ...
    ("UTF-32-BE", re.compile(hex2re("00 00 FE FF")).match),
    ("UTF-32-LE", re.compile(hex2re("FF FE 00 00")).match),
    #    ('UTF-32-2143', re.compile(
    #        hex2re('00 00 FF FE')).match),
    #    ('UTF-32-3412', re.compile(
    #        hex2re('FE FF 00 00')).match),
    ("UTF-16-BE", re.compile(hex2re("FE FF")).match),
    ("UTF-16-LE", re.compile(hex2re("FF FE")).match),
