...
xml_entity_to_unicode = functools.partial(
    entity_to_unicode,
    result_exceptions={
        '"': "&quot;",
        "'": "&apos;",
...
def replace_entities(raw, encoding="cp1252"):
    return ENT_PAT.sub(functools.partial(entity_to_unicode, encoding=encoding), raw)


def xml_replace_entities(raw, encoding="cp1252"):
    return ENT_PAT.sub(functools.partial(xml_entity_to_unicode, encoding=encoding), raw)
